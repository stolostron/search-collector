...
func (h HelmReleaseResource) BuildNode() Node {
	...
	if h.Release != nil {
		...
		node.Properties["namespace"] = h.Release.GetNamespace() //nolint // "could remove embedded field 'Release' from selector
...
func getSummarizedManifestResources(h HelmReleaseResource) []SummarizedManifestResource {
	...
	*/
	...
	manifest := h.Release.GetManifest() //nolint // "could remove embedded field 'Release' from selector
