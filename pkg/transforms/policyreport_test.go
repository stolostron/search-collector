...
func TestTransformPolicyReport(t *testing.T) {
	...
	AssertDeepEqual("ruleNames", len(node.Properties["ruleNames"].([]string)), 0, t)
...
func TestTransformKyvernoClusterPolicyReport(t *testing.T) {
	...
	AssertDeepEqual("ruleNames", node.Properties["ruleNames"], []string{"no-monkey", "require-labels"}, t)
...
func TestTransformKyvernoPolicyReport(t *testing.T) {
	...
	AssertDeepEqual("ruleNames", node.Properties["ruleNames"], []string{"require-labels"}, t)
	AssertDeepEqual("numRuleViolations", node.Properties["numRuleViolations"], 2, t)
	expected := map[string]int{
