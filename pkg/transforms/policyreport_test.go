...
func TestTransformPolicyReport(t *testing.T) {
	...
	node := PolicyReportResourceBuilder(&pr, &unstructured.Unstructured{}).BuildNode()
...
func TestKyvernoClusterPolicyReportBuildEdges(t *testing.T) {
	...
	edges := PolicyReportResourceBuilder(&pr, &unstructured.Unstructured{}).BuildEdges(nodeStore)
